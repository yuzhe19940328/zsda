...
from data_loader import get_loader_m
...
parser.add_argument("--m_dataset",type=str,default='m',help="dataset type")
...
for epoch in range(opt.n_epochs):
    for i, (imgs1, imgs2,_) in enumerate(train_loader):
